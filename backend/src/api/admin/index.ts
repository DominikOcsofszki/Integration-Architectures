...
import {
    ...
    updateSalesman,
    deleteSalesman,
} from "./salesman-crud-api";
import {
    createBonusComputationSheet,
    readBonusComputationSheet,
    updateBonusComputationSheet,
    deleteBonusComputationSheet,
} from "./bonus-sheet-crud-api";
...
router.delete(
    "/sheet/:salesmanId/:yearOfEvaluation",
    deleteBonusComputationSheet
);
